...
/* Plays the adventurer card from the players hand */

int smithyCard(struct gameState *state, int handPos);
/* Plays the smithy card from the players hand */

int embargoCard(struct gameState *state, int choice1, int handPos);
/* Plays the embargo card from the players hand */

int cutpurseCard(struct gameState *state, int handPos);
/* Plays the cutpurse card from the players hand */

int feastCard(struct gameState *state, int choice1);
/* Plays the feast card from the players hand */
